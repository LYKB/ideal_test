                                    ...
                                    <div class="submit-page form-simple">
                                        <div class="frm_submit_block">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>月租金额<a href="#" class="tip-topdata" data-tip="日租金 = 月租金/30"><i class="ti-help"></i> </a></label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="city" class="form-control">
                                                        ...
                                                        <option value="常州" <c:if test="${house.city == '常州'}">selected</c:if>>常州</option>
                                                        <option value="苏州" <c:if test="${house.city == '苏州'}">selected</c:if>>苏州</option>
                                                        <option value="南京" <c:if test="${house.city == '南京'}">selected</c:if>>南京</option>
                                                        <option value="无锡" <c:if test="${house.city == '无锡'}">selected</c:if>>无锡</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-8">
                                                    <label>房子详细地址信息<a href="#" class="tip-topdata" data-tip="如江苏省常州市新北区世界之窗世界花园小区88栋808室A卧"><i class="ti-help"></i></a></label>
                                                    <input type="text" name="address" class="form-control" value="${house.address}">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>经纬度坐标<a href="https://api.map.baidu.com/lbsapi/getpoint/index.html" target="_blank">点击获取</a><a href="#" class="tip-topdata" data-tip="经纬度，如116.23544,30.21254″"><i class="ti-help"></i></a></label>
                                        ...
                                        <div class="frm_submit_block">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>面积<a href="#" class="tip-topdata" data-tip="整租类型是为整个房子的面积，合租类型是为单间的面积"><i class="ti-help"></i></a></label>
...
<script>
    $(function () {
        ...
        $("#file").fileinput({
            ...
            allowedFileExtensions: ['png','jpg','gif','jpeg'],  //允许上传的文件后缀
