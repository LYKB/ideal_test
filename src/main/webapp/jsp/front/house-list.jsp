                    ...
                    <form action="/house" method="get">
                        <div class="form-group">
                            <select name="city" id="city" class="form-control">
                                ...
                                <option value="常州" <c:if test="${houseSearchVO.city == '常州'}">selected</c:if>>常州</option>
                                <option value="苏州" <c:if test="${houseSearchVO.city == '苏州'}">selected</c:if>>苏州</option>
                                <option value="南京" <c:if test="${houseSearchVO.city == '南京'}">selected</c:if>>南京</option>
                                <option value="无锡" <c:if test="${houseSearchVO.city == '无锡'}">selected</c:if>>无锡</option>
                            </select>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="property_caption_wrappers pb-0">
                                    <div class="property_short_detail">
                                        <div class="pr_type_status">
                                            <h4 class="pr_property_title mb-1"><a href="/house/detail/${c.id}">${c.title}</a></h4>
