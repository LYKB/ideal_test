            ...
            <div class="col-lg-12 col-md-12">
                <div class="property_block_wrap style-2">
                    <div id="content" style="padding: 10px;">
                        <h2 style="text-align: center;margin-top: 50px;">  房屋租售合同</h2>
                        ...
                        <p>     根据甲、乙双方在自愿、平等、互利的基础上，经协商一致，为明确双方之间的权力义务关系，就甲方将其合法拥有的房屋出租给乙方使用，乙方承担甲方房屋事宜，订立本合同。</p>
                        ...
                        <p>     2、房屋租金：每日<strong> 
                            ...
                            <strong>${order.dayNum}</strong>天，押金<strong>θ</strong>元，共计
                            <strong>${order.totalAmount}</strong>
                            元。</p>
                        <p>     房屋终止，甲方验收无误后，将押金退还乙方，不计利息。</p>
                        <p>     3、乙方向甲方承诺，租赁该房屋仅作为普通住房使用。</p>
                        <p>     4、租赁期清，甲方有权收回出租房屋，乙方应如期交还。乙方如要求续租，则必须在租赁期满前一个月内通知甲方，经甲方同意后，重新签订租三、房屋修缮与使用</p>
                        <p>     三、房屋修缮与使用</p>
                        <p>     1、在粗重腾内，甲方应保证出租房屋的使用安全。乙方应合理使用其所承担的房屋及其附属设施。如乙方的使用不当满足房屋及这期提坏的，乙方应负责修复或给予经济补偿</p>
                        <p>     2.该房屋及所属设施的维修责任除双方在本台同及补充条款中约定外，均由甲方负责(但乙方使用不当除外)。甲方进行维修需提前七大通知乙方，乙方应积极协助配合。</p>
                        <p>
                                3、乙方因使用需要，在不影响房屋结构的前提下，可以对房屋进行装修装饰，但其设计规模、刻度、工艺、用科学方案应事先征得甲方的同意后方可施工。</p>
                        <p>     四、房屋的转让与转租</p>
                        <p>     1、租赁期间，未经甲方书面同意，乙方不得擅自转租、转借承租房屋。</p>
                        <p>     2、甲方同意乙方转租房屋的，应当单独订立补充协议，乙方应当依据与甲方的书面协议转租房屋。</p>
                        <p>     五、乙方违约的处理规定</p>
                        <p>
                                在租赁期内，乙方有下列行为之一的，甲方有权终止合同，收回该房屋，乙方应向甲方支付合同总组金20%的违约金。若支付的违约金不足弥补甲方损失，乙方还应复制赔偿直至达到弥补甲方损失为止。</p>
                        ...
                        <p>     甲方签字：________________________ 乙方签字：________________________</p>
                        <p>     联系方式：________________________ 联系方式：________________________</p>
                    </div>
                    <div style="text-align: center;margin-top: 50px;">
                        <%--订单状态：-2待签合同.-1净付款，0生效中，1已判职，-3已取消.2申请退租，3申请退租不通过--%>
                        <c:choose>
