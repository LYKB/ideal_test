...
<div class="image-cover hero_banner"
     style="background: #334aca url('${pageContext.request.contextPath}/assets/img/banner-3.jpg') no-repeat;"
     data-overlay="1">
    <div class="container">
        <h1 class="big-header-capt mb-0">开始一段美好的租房生活吧！</h1>
        <p class="text-center mb-5">搜索你所在的城市的小区的房屋类型吧！</p>
