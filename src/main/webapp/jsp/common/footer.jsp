...
<fonter class="dake-footer skin-dark-footer style-2" style="padding-top: 0;">
    <div class="footer-bottom">
        <div class="container">
            <div class="row justify-content-center">
                <p class="mb-0" style="color: white">© 2022 计科5班1815302528卢意</p>
            </div>
        </div>
    </div>
</fonter>
        ...
        <div class="modal-content" id="sign-up">
            <div class="modal-body">
                <form id="registerForm">
                    <div class="row">
                        <div class="col-lg-12 col-md-12"><%--12就是一个页面平均分成12份--%>
